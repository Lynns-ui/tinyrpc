...
class makeOrderReponse;
struct makeOrderReponseDefaultTypeInternal;
extern makeOrderReponseDefaultTypeInternal _makeOrderReponse_default_instance_;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::makeOrderReponse* Arena::CreateMaybeMessage<::makeOrderReponse>(Arena*);
...
class makeOrderReponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:makeOrderReponse) */ {
 public:
  inline makeOrderReponse() : makeOrderReponse(nullptr) {}
  ~makeOrderReponse() override;
  explicit constexpr makeOrderReponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  makeOrderReponse(const makeOrderReponse& from);
  makeOrderReponse(makeOrderReponse&& from) noexcept
    : makeOrderReponse() {
    *this = ::std::move(from);
  }

  inline makeOrderReponse& operator=(const makeOrderReponse& from) {
    CopyFrom(from);
    return *this;
  }
  inline makeOrderReponse& operator=(makeOrderReponse&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const makeOrderReponse& default_instance() {
    return *internal_default_instance();
  }
  static inline const makeOrderReponse* internal_default_instance() {
    return reinterpret_cast<const makeOrderReponse*>(
               &_makeOrderReponse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    1;

  friend void swap(makeOrderReponse& a, makeOrderReponse& b) {
    a.Swap(&b);
  }
  inline void Swap(makeOrderReponse* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(makeOrderReponse* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  makeOrderReponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<makeOrderReponse>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const makeOrderReponse& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const makeOrderReponse& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(makeOrderReponse* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "makeOrderReponse";
  }
  protected:
  explicit makeOrderReponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  ...
  // @@protoc_insertion_point(class_scope:makeOrderReponse)
 private:
  class _Internal;
...
// int32 res_code = 1;
inline void makeOrderReponse::clear_res_code() {
  res_code_ = 0;
}
inline int32_t makeOrderReponse::_internal_res_code() const {
  return res_code_;
}
inline int32_t makeOrderReponse::res_code() const {
  // @@protoc_insertion_point(field_get:makeOrderReponse.res_code)
  return _internal_res_code();
}
inline void makeOrderReponse::_internal_set_res_code(int32_t value) {
  
  res_code_ = value;
}
inline void makeOrderReponse::set_res_code(int32_t value) {
  _internal_set_res_code(value);
  // @@protoc_insertion_point(field_set:makeOrderReponse.res_code)
}

// string res_info = 2;
inline void makeOrderReponse::clear_res_info() {
  res_info_.ClearToEmpty();
}
inline const std::string& makeOrderReponse::res_info() const {
  // @@protoc_insertion_point(field_get:makeOrderReponse.res_info)
  return _internal_res_info();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void makeOrderReponse::set_res_info(ArgT0&& arg0, ArgT... args) {
 ...
 res_info_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:makeOrderReponse.res_info)
}
inline std::string* makeOrderReponse::mutable_res_info() {
  std::string* _s = _internal_mutable_res_info();
  // @@protoc_insertion_point(field_mutable:makeOrderReponse.res_info)
  return _s;
}
inline const std::string& makeOrderReponse::_internal_res_info() const {
  return res_info_.Get();
}
inline void makeOrderReponse::_internal_set_res_info(const std::string& value) {
  
  res_info_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* makeOrderReponse::_internal_mutable_res_info() {
  
  return res_info_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* makeOrderReponse::release_res_info() {
  // @@protoc_insertion_point(field_release:makeOrderReponse.res_info)
  return res_info_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void makeOrderReponse::set_allocated_res_info(std::string* res_info) {
  if (res_info != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:makeOrderReponse.res_info)
}

// string order_id = 3;
inline void makeOrderReponse::clear_order_id() {
  order_id_.ClearToEmpty();
}
inline const std::string& makeOrderReponse::order_id() const {
  // @@protoc_insertion_point(field_get:makeOrderReponse.order_id)
  return _internal_order_id();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void makeOrderReponse::set_order_id(ArgT0&& arg0, ArgT... args) {
 ...
 order_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:makeOrderReponse.order_id)
}
inline std::string* makeOrderReponse::mutable_order_id() {
  std::string* _s = _internal_mutable_order_id();
  // @@protoc_insertion_point(field_mutable:makeOrderReponse.order_id)
  return _s;
}
inline const std::string& makeOrderReponse::_internal_order_id() const {
  return order_id_.Get();
}
inline void makeOrderReponse::_internal_set_order_id(const std::string& value) {
  
  order_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* makeOrderReponse::_internal_mutable_order_id() {
  
  return order_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* makeOrderReponse::release_order_id() {
  // @@protoc_insertion_point(field_release:makeOrderReponse.order_id)
  return order_id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void makeOrderReponse::set_allocated_order_id(std::string* order_id) {
  if (order_id != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:makeOrderReponse.order_id)
}
