...
constexpr makeOrderReponse::makeOrderReponse(
  ::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized)
...
struct makeOrderReponseDefaultTypeInternal {
  constexpr makeOrderReponseDefaultTypeInternal()
    : _instance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized{}) {}
  ~makeOrderReponseDefaultTypeInternal() {}
  union {
    makeOrderReponse _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT makeOrderReponseDefaultTypeInternal _makeOrderReponse_default_instance_;
...
const uint32_t TableStruct_order_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::makeOrderReponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::makeOrderReponse, res_code_),
  PROTOBUF_FIELD_OFFSET(::makeOrderReponse, res_info_),
  PROTOBUF_FIELD_OFFSET(::makeOrderReponse, order_id_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::makeOrderRequest)},
  { 8, -1, -1, sizeof(::makeOrderReponse)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::_makeOrderRequest_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::_makeOrderReponse_default_instance_),
};

const char descriptor_table_protodef_order_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\013order.proto\"0\n\020makeOrderRequest\022\r\n\005pri"
  "ce\030\001 \001(\005\022\r\n\005goods\030\002 \001(\t\"H\n\020makeOrderRepo"
  "nse\022\020\n\010res_code\030\001 \001(\005\022\020\n\010res_info\030\002 \001(\t\022"
  "\020\n\010order_id\030\003 \001(\t2:\n\005Order\0221\n\tmakeOrder\022"
  "\021.makeOrderRequest\032\021.makeOrderReponseB\003\200"
  "\001\001b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_order_2eproto = {
  false, false, 210, descriptor_table_protodef_order_2eproto, "order.proto", 
...
class makeOrderReponse::_Internal {
 public:
};

makeOrderReponse::makeOrderReponse(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor();
  if (!is_message_owned) {
  ...
  // @@protoc_insertion_point(arena_constructor:makeOrderReponse)
}
makeOrderReponse::makeOrderReponse(const makeOrderReponse& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ...
  // @@protoc_insertion_point(copy_constructor:makeOrderReponse)
}

inline void makeOrderReponse::SharedCtor() {
res_info_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  res_info_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
makeOrderReponse::~makeOrderReponse() {
  // @@protoc_insertion_point(destructor:makeOrderReponse)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}

inline void makeOrderReponse::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
...
void makeOrderReponse::ArenaDtor(void* object) {
  makeOrderReponse* _this = reinterpret_cast< makeOrderReponse* >(object);
  (void)_this;
}
void makeOrderReponse::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void makeOrderReponse::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}

void makeOrderReponse::Clear() {
// @@protoc_insertion_point(message_clear_start:makeOrderReponse)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* makeOrderReponse::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::PROTOBUF_NAMESPACE_ID::internal::ReadTag(ptr, &tag);
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          res_code_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "makeOrderReponse.res_info"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "makeOrderReponse.order_id"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* makeOrderReponse::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:makeOrderReponse)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:makeOrderReponse)
  return target;
}

size_t makeOrderReponse::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:makeOrderReponse)
  size_t total_size = 0;
  ...
  // int32 res_code = 1;
  if (this->_internal_res_code() != 0) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32SizePlusOne(this->_internal_res_code());
  }

  return MaybeComputeUnknownFieldsSize(total_size, &_cached_size_);
}

const ::PROTOBUF_NAMESPACE_ID::Message::ClassData makeOrderReponse::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    makeOrderReponse::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*makeOrderReponse::GetClassData() const { return &_class_data_; }

void makeOrderReponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<makeOrderReponse *>(to)->MergeFrom(
      static_cast<const makeOrderReponse &>(from));
}


void makeOrderReponse::MergeFrom(const makeOrderReponse& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:makeOrderReponse)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void makeOrderReponse::CopyFrom(const makeOrderReponse& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:makeOrderReponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool makeOrderReponse::IsInitialized() const {
  return true;
}

void makeOrderReponse::InternalSwap(makeOrderReponse* other) {
  using std::swap;
  auto* lhs_arena = GetArenaForAllocation();
  auto* rhs_arena = other->GetArenaForAllocation();
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
...
::PROTOBUF_NAMESPACE_ID::Metadata makeOrderReponse::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_order_2eproto_getter, &descriptor_table_order_2eproto_once,
    ...
    case 0:
      makeOrder(controller,
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::makeOrderRequest*>(
                 request),
             ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::makeOrderReponse*>(
                 response),
             done);
      break;
    default:
...
const ::PROTOBUF_NAMESPACE_ID::Message& Order::GetResponsePrototype(
  ...
  switch(method->index()) {
    case 0:
      return ::makeOrderReponse::default_instance();
    default:
      GOOGLE_LOG(FATAL) << "Bad method index; this should never happen.";
      return *::PROTOBUF_NAMESPACE_ID::MessageFactory::generated_factory()
...
template<> PROTOBUF_NOINLINE ::makeOrderReponse* Arena::CreateMaybeMessage< ::makeOrderReponse >(Arena* arena) {
  return Arena::CreateMessageInternal< ::makeOrderReponse >(arena);
}
